...
$mypatientrow = $database->query("select patient.* from patient JOIN appointment ON appointment.pid=patient.pid where doc_id='$doc_id';");
...
<section id="hero" class="d-flex align-items-center ">
    <div class="container">
        ...
        $appointments = $database->query("select  * from  appointment where doc_id='$doc_id';");
