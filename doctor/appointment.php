    ...
    <div class="container d-flex align-items-center">
        ...
        <nav id="navbar" class="navbar order-last order-lg-0">
            <ul>
                ...
                <li><a class="nav-link scrollto active" href="appointment.php">Appointments</a></li>
        ...
        <div class="row ">
            <div class="col-12">
                ...
                <p class="" style="margin-left: 45px;font-size:18px;color:rgb(49, 49, 49)">My Appointments
                    (<?php
                    $doc_id = $database->query("select  * from  doctor where email='$_SESSION[user]';")->fetch_assoc()["doc_id"];
                    $appointments_query_result = $database->query("select  * from  appointment where doc_id='$doc_id' order by date asc ;");
                    ...
                    <table width="93%" class="sub-table scrolldown" border="0">
                        ...
                        if ($appointments_query_result->num_rows == 0) {
                            echo '<tr>
                                    ...
                                    <a class="non-style-link" href="appointment.php"><button  class="login-btn btn-primary-soft btn"  style="display: flex;justify-content: center;align-items: center;margin-left:20px;">&nbsp; Show all appointment &nbsp;</font></button>
                                    </a>
                                    </center>
                                    <br><br><br><br>
                                    </td>
...
//                                    $spcil_name = $spcil_array["sname"];
                                echo '<tr>
                                    ...
                                    $dname . '</td>
                                        ...
                                        <a href="?action=drop&id=' . $app_nr . '&error=0" class="non-style-link"><button  class="btn-primary-soft btn button-icon btn-edit"  style="padding-left: 40px;padding-top: 12px;padding-bottom: 12px;margin-top: 10px;"><font class="tn-in-text">Delete</font></button></a>
                                        &nbsp;&nbsp;&nbsp;
                                        </div>
                                        </td>
                                    </tr>';
